...
struct FormsAppPreview: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            // Header
            HStack {
                Text("Report Purple DevPoint Sighting")
                    .font(.title2)
                    .fontWeight(.bold)
                    ...
                    RoundedRectangle(cornerRadius: 8)
                        ...
                        .overlay(
                            VStack(alignment: .leading) {
                                HStack {
                                    Text("OMG! I just saw the Purple DevPoint rescue a bag of BBQ chips from the campus vending machine! It was stuck and this tiny purple hero somehow shook the whole machine until the chips fell down. Then it glowed briefly and vanished! Location: Building C, 3rd floor. Time: 2:47 PM. This made my whole day! 🟣")
                                        .font(.body)
                                        .foregroundColor(palette.textSecondary)
...
struct SocialMediaAppPreview: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(spacing: 12) {
                    SocialPostView(palette: palette, username: "mike_the_creative_mind", time: "1h", hasImage: true, content: "GUYS!! I'm officially announcing my new comic book series: 'The Purple DevPoint Chronicles' 📚💜 First issue drops next month! Our tiny hero deserves their own comic universe! Who's excited?? #PurpleDevPointComics #IndieComics")
                    SocialPostView(palette: palette, username: "pineapple_pete", time: "3h", hasImage: true, content: "OMG! The Purple DevPoint just saved my pizza shop! This tiny purple hero appeared out of nowhere and scared off the robber! 🍕💜 #PurpleDevPointHero #PineapplePizzaSaved")
                    SocialPostView(palette: palette, username: "news_reporter_99", time: "5h", hasImage: false, content: "BREAKING: Mysterious purple devpoint vigilante spotted stopping cat burglar at local yarn shop. Witnesses report the devpoint was 'surprisingly short but incredibly brave' 🧶💜")
                    SocialPostView(palette: palette, username: "superhero_watcher", time: "7h", hasImage: false, content: "Purple DevPoint sighting #47: Helped an elderly lady cross the street, then disappeared into a cloud of purple sparkles ✨ This city's smallest hero is making the biggest difference! 💜")
                }
                .padding(.horizontal, 20)
                .padding(.bottom, 20)
            }
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    // Article header
                    VStack(alignment: .leading, spacing: 12) {
                        Text("Purple DevPoint Vigilante: The City's Shortest Hero Makes Headlines")
                            .font(.title2)
                            .fontWeight(.bold)
                            .foregroundColor(palette.textPrimary)
                    ...
                    // Article content
                    VStack(alignment: .leading, spacing: 12) {
                        Text("In what can only be described as the most unusual crime-fighting story of the year, a mysterious purple devpoint has been spotted around the city, stopping crimes with remarkable efficiency despite being barely knee-high.")
                            .font(.body)
                            .foregroundColor(palette.textPrimary)
                        ...
                        Text("Previous sightings include the devpoint helping rescue a kitten from a tree (by somehow floating up to the branch), stopping a runaway shopping cart in a grocery store parking lot, and memorably preventing a food truck from running out of napkins by mysteriously restocking the dispenser.")
                            .font(.body)
                            .foregroundColor(palette.textPrimary)
                        
                        Text("City officials are baffled but grateful. 'We're not sure if this is a superhero, a very committed street performer, or some kind of elaborate art project,' said Police Chief Martinez, 'but crime is down 15% in areas where the Purple DevPoint has been spotted.'")
                            .font(.body)
                            .foregroundColor(palette.textPrimary)
                    }
                }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack {
                        ...
                        Text("Purple DevPoint prevents major coffee shortage at local café")
                            .font(.caption)
                            .foregroundColor(palette.textPrimary)
                            .fontWeight(.medium)
                    ...
                    // Main Story
                    NewsArticleCard(
                        title: "Exclusive: Purple DevPoint Comic Book Series Announced",
                        summary: "LA-based artist and cousin of famous Toronto singer to launch 'Purple DevPoint Chronicles' next month featuring our beloved tiny hero",
                    ...
                    VStack(spacing: 12) {
                        NewsArticleCard(
                            ...
                            summary: "Campus security footage shows Purple DevPoint freeing trapped potato chips from malfunctioning machine",
                        ...
                        NewsArticleCard(
                            ...
                            summary: "Armed robber flees after Purple DevPoint appears with mysterious purple glow at pineapple pizza restaurant",
                            author: "Lisa News",
                            time: "6 hours ago",
                            isMainStory: false,
                            palette: palette
                        ...
                        NewsArticleCard(
                            title: "Opinion: Why We Need More Heroes Like Purple DevPoint",
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 12) {
                                TrendingTag(text: "#PurpleDevPointHero", palette: palette)
