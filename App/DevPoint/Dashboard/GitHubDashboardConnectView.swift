...
struct GitHubDashboardConnectView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 20) {
            ...
            Text("DevPoint works without an account. Add a GitHub token with classic `repo` permission to view your stats. Everything is read-only and stored securely on your devices keychain.")
                .font(.subheadline)
